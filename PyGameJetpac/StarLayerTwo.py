...
#         # screen.blit(self.image, self.m_star_layer1, self.m_rect)
#         # screen.blit(self.image, self.m_star_layer2, self.m_rect)
#         #pygame.draw.circle(surface, color, center, radius)
#         pygame.draw.circle(screen, pygame.Color(89,89,89), self.m_star_layer1, 1)
