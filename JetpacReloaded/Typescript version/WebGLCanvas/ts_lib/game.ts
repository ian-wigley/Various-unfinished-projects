...
import { Keys } from "./keyboardstate.js";
...
export class Game {
    ...
    public get Content() {
        // Pass the gl context to the content for use by the Texture2d
        if (this.spriteBatch != null) {
            this.spriteBatch.configureGL();
            this.content.GL = this.spriteBatch.GL;
        }
        return this.content;
    }
