...
import { SpriteBatch, SpriteEffects} from "../ts_lib/spritebatch.js";
...
export class JetPacReloaded extends Game {
    ...
    private m_levelManager: LevelManager;
    ...
    protected Initialize(): void {
        ...
        // // TODO => temp 3d integration stuff
        // this.m_graphics.Initialise();
    ...
    protected LoadContent(): void {
        // Spritebatch field lives in the base class
    ...
    private checkForHorizontalIntersections(increment: number): number {
        ...
        // this.m_levelManager.TileList.forEach(function (tile) {
    ...
    protected Draw(gameTime: GameTime): void {
        this.spriteBatch.Clear(Color.CornflowerBlue);
        ...
        if (this.gameState == GameState.gameOver) {
            ...
            //     }
            this.spriteBatch.Begin(this.m_camera.Transform);
            this.spriteBatch.Draw(this.m_rustyTexture, new Vector2(0, 0), Color.White);
            this.m_levelManager.TileList.forEach(i => {
                if (i.Drawable(this.x, this.y)) {
                    // // this.m_spriteBatch.Draw(this._texture, i.TileRect, i.TileTexture, Color.White);
                    this.spriteBatch.Draw(this.undergroundTiles, i.TileRect, i.TileTexture, Color.White);
                }
            });
            // //     this.m_stars.forEach(function (star) {
            ...
            // //     });
            this.m_jetman.Draw(this.spriteBatch);
            // this.m_spriteBatch.End();
            // // this.m_particles.forEach(function (particle) {
            ...
            this.spriteBatch.DrawString(this.m_font, "SCORE : " + this.m_score, this.scoreLocation, Color.Yellow);
            ...
            this.spriteBatch.DrawString(this.m_font, "x : " + this.x + " y : " + this.y, new Vector2(10, this.scoreLocation.Y + 15), Color.Yellow);
            ...
            this.spriteBatch.DrawString(this.m_font, "x camera : " + this.m_camera.CameraPos.X + " y camera : " + this.m_camera.CameraPos.Y, new Vector2(10, this.scoreLocation.Y + 45), Color.Yellow);
            this.spriteBatch.DrawString(this.m_font, "x : " + this.m_jetman.JetmanPosition.X + " y : " + this.m_jetman.JetmanPosition.Y, new Vector2(10, this.scoreLocation.Y + 60), Color.Yellow);
            // this.m_spriteBatch.End();
        }
        super.Draw(gameTime);
    }
