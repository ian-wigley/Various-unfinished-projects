...
public class AssemblyCreator
{
    ...
    public List<string> PassOne { get; } = new();
    public List<string> PassTwo { get; } = new();
    public List<string> PassThree { get; } = new();
    public List<string> Found { get; } = new();
    public Dictionary<string, string> LabelLocations { get; } = new();
    public Dictionary<string, string> BranchLocations { get; } = new();
    ...
    )
    {
        ...
        while (firstPass)
        {
            ...
            if (lineDetails.Length > 1)
            {
                ...
                if (replaceIllegalOpcodes && replacedWithDataStatements.TryGetValue(lineDetails[0], out var dataValue))
