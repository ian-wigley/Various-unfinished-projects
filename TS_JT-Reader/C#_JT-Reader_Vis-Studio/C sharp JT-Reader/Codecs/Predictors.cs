...
namespace C_sharp_JT_Reader.Codecs
{
    public class Predictors
    {
        ...
        // Apply the predictor algorithm on the residual values to obtain the primal values
        ...
        public static int[] unpackResidualsOverwrite(int[] residuals, PredictorType predType)
        {
